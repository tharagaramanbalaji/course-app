        ...
        <div className="brand-gradient-subtle flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-[#7ABA78]/40 p-5 shadow-xs">
          <div>
            ...
            <p className="mt-1 text-xs text-[#0A6847]/80">
              Your official Certificate of Completion is ready for download.
            </p>
          </div>
          {certificateQuery.data && (
            <button
              ...
              className="btn-primary-sm flex items-center gap-2 px-4 py-2 font-bold shadow-sm disabled:opacity-50"
            >
              {isDownloading ? (
                <>
                ...
                <>
                  ...
                  <span>Download Certificate ({certificateQuery.data.certificateNumber})</span>
                </>
              )}
            </button>
          )}
